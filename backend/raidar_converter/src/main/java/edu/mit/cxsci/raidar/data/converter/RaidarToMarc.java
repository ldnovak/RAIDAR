...
//				System.out.println("code====" + code);
	...
	private Raidar FromJsonToModel() {
		...
		asset = gson.fromJson(jsonString, Raidar.class);
	...
	private void createMarc() {
		...
		RaidarHeaderInfo object = asset.getAssetHeaderInfo();
		...
		RaidarResourceList assetResourceList = asset.getAssetResourceList();
