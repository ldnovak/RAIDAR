...
public class DisplayArtist {
	ArrayList<Identity> full_names = new ArrayList<Identity>();
	private Date date;
	ArrayList<ContactInfo> contact_infos = new ArrayList<ContactInfo>();
	ArrayList<String> artist_roles = new ArrayList<String>();
	...
	AudioTechnicalDetail audio_technical_detail;
